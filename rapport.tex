...
La simulation de référence montre que les
...
Il y a une très forte domination du variant 1 sur le variant 2 bien que le taux d'infecté soit supérieur pour le variant 2 au début de la simulation. Les taux de contagions sont les mêmes mais il y a une différence dans les taux de virulence. \\
Il n'y a pas de forte différence entre le variant 3 et 4, ils sont tout les deux issus du variant 1. \\ Ils restent plus fort que le variant 1 parent.
...
On remarque qu'avec un taux de contagion plus élevé, le variant 1 infecte quasiment toute la population très rapidement et devient le parent ou grand-parent de tout les variants. \\
...
On remarque qu'avec un taux de virulence plus faible, le variant 1 infecte quasiment toute la population et le taux de rémission reste faible après 2000 jours. \\
De plus la plupart des variants (Variant 4, 5, 7, 8, 10) sont plus fort que le variant parent à la fin de la simulation. \\
...
\begin{figure}[h]
    ...
    \caption{Simulation avec les variants initiaux}
...
On peut noter qu'étant donné que la population ne baisse pas (le décès n'est pas modélisé), elle ne peut donc que se remettre. Ainsi, avec une durée 'infinie', on obtient un taux de rémission toujours revenu à la totalité de la population. \\
